        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-lg sm:rounded-2xl shadow-2xl border border-white/20 p-6 sm:p-8">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className={`w-full pl-9 sm:pl-10 pr-4 py-2.5 sm:py-3 border rounded-lg sm:rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 text-sm sm:text-base ${
                    error
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className={`w-full pl-9 sm:pl-10 pr-12 py-2.5 sm:py-3 border rounded-lg sm:rounded-lg focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 text-sm sm:text-base ${
                    error
                      ? "border-red-300 focus:ring-red-500"
                      : "border-gray-300 focus:ring-purple-500"
                  }`}
          ...
          <div className="space-y-3">
            <button
              ...
              disabled={loading}
              className={`w-full py-2.5 sm:py-3 px-6 border border-gray-300 rounded-lg sm:rounded-lg transition-colors duration-200 flex items-center justify-center gap-3 text-sm sm:text-base ${
                loading
